...
CREATE ROLE root;
ALTER ROLE root WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:NZ+vvUAn7O47bzm0U8eaqA==$XTeJpUDn3PSlDLGfW2xGGVGckPDREOhwudz2/oOUT7I=:lbp5rwYy9QrtU0RsxA8/NUFc9aCgvaJ/fpPAg/kLgOg=';
...
ALTER SEQUENCE public.questions_id_seq OWNER TO root;
